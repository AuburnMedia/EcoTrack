...
def get_carbon_usage_data(user=None):
    ...
    if user and user.is_authenticated:
        try:
            ...
            initial_survey = InitialSurveyResult.objects.filter(user=user).latest('date_submitted')
    ...
    if user and user.is_authenticated:
        try:
            ...
            if weekly_checkups.exists():
                ...
                average_usage = [round(usage * 1.2, 1) for usage in your_usage]  # 20% higher than user
